...
function startGame(difficulty) {
    ...
    document.getElementById('game-title').innerText = `${difficulty} Translation Game`;
...
function loadQuestions(difficulty) {
    const filePath = difficulty === 'Easy'
        ? 'content/easyTranslationQuestions.json'
        : 'content/advancedTranslationQuestions.json';
